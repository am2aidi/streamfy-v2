...
export default function MusicDetailPage() {
  ...
  return (
    <div className="flex min-h-screen bg-black">
      ...
      <div className="ml-[220px] w-[calc(100vw-220px)] min-h-[100dvh] overflow-x-hidden pb-24">
        <Header />
        <main className="px-6 flex flex-col gap-6">
          ...
          <section className="rounded-2xl border border-white/10 bg-white/[0.04] p-4">
            <SocialShareLinks title="Share This Track" />
          </section>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6 flex gap-5">
            ...
            <div className="flex flex-col justify-center">
              ...
              <button
                onClick={() => requireAuth(() => {}, 'Sign in to listen to music.')}
          ...
          <section>
            <h2 className="text-white text-xl font-bold mb-3">Playlist</h2>
